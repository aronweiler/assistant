...
class SupportedSourceControlProviderModel:
    ...
    def to_database_model(self):
        return SupportedSourceControlProvider(
            id=self.id,
            name=self.name
        )
...
class SourceControlProviderModel:
    def __init__(self, supported_source_control_provider_id, source_control_provider_name, source_control_provider_url, requires_authentication, source_control_access_token, last_modified=None, id=None):
        self.id = id
