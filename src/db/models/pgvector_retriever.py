...
class PGVectorRetriever(BaseRetriever):
    ...
    def _get_relevant_documents(
        ...
        documents = self.vectorstore.search_document_embeddings(search_query=query, collection_id=collection_id, search_type=search_type, top_k=top_k, target_file_id=target_file_id)
