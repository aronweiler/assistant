...
class TaskCoordinatorAI:
    def configure(self, json_args):
        ...
        self.task_refinement_ai: AbstractLLM = json_args["task_refinement_ai"]
        self.tool_using_ai: AbstractLLM = json_args["tool_using_ai"]
        self.collapse_results_ai: AbstractLLM = json_args["collapse_results_ai"]
    ...
    def get_subordinate_ai(self, ai_name) -> AbstractLLM:
